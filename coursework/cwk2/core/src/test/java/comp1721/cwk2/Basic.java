...
public class Basic {
  ...
  public void cardStringRepresentation() {
    assertAll(
      () -> assertThat(aceClubs.toString(), is("AC")),
      () -> assertThat(nineDiamonds.toString(), is("9D")),
      () -> assertThat(tenHearts.toString(), is("TH")),
      () -> assertThat(kingSpades.toString(), is("KS"))
    );
  }
  ...
  public void naturalHand() {
    ...
    assertAll(
      ...
      () -> assertThat(handOneCard.isNatural(), is(true)),
  ...
  public void handStringRepresentation() {
    assertAll(
      ...
      () -> assertThat(handOneCard.toString(), is("9D")),
      () -> assertThat(handTwoCards.toString(), is("9D 2C"))
    );
  }
  ...
  public void dealFromShoe() {
    ...
    assertAll(
      () -> assertThat(smallShoe.size(), is(SMALL_SHOE_SIZE - 2)),
  ...
  public void shuffle() {
    smallShoe.shuffle();
    String cards = String.format("%s%s%s", smallShoe.deal(), smallShoe.deal(), smallShoe.deal());
    assertThat(cards, not("AC2C3C"));
  }
